...
public class TestGroupService {
    ...
    public void giveApproveSubjectPrivilegeTo(Group group, SubjectType ... subjectTypes) {
        Arrays.stream(subjectTypes).forEach(subjectType -> {
            this.givePrivilege(group, new TestGroupPrivilegeBuilder().withDefaultValuesForNewEntity().setSubjectType(subjectType).build(), PrivilegeType.ApproveSubject);
        });
    }
