...
ALTER TABLE if exists BATCH_STEP_EXECUTION ALTER COLUMN START_TIME DROP NOT NULL;

ALTER TABLE if exists BATCH_JOB_EXECUTION_PARAMS DROP COLUMN DATE_VAL;

ALTER TABLE if exists BATCH_JOB_EXECUTION_PARAMS DROP COLUMN LONG_VAL;

ALTER TABLE if exists BATCH_JOB_EXECUTION_PARAMS DROP COLUMN DOUBLE_VAL;
