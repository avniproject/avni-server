...
/**
 * Spring Boot configuration properties for Avni Camp.
 * Maps to the camp configuration properties in application.properties.
 */
@ConfigurationProperties(prefix = "avni.camp")
public class CampConfigurationProperties {
