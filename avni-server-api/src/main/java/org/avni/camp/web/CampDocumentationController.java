...
public class CampDocumentationController {
    ...
    public ResponseEntity<Map<String, Object>> getApiDocumentation() {
        ...
        fullSync.put("path", "/api/camp/full");
        ...
        uploadSync.put("path", "/api/camp/upload-only");
        ...
        status.put("path", "/api/camp/status");
        ...
        config.put("path", "/api/camp/config");
        ...
        diagnostics.put("path", "/api/camp/diagnostics");
        ...
        entityMetadata.put("path", "/api/camp/entity-metadata");
    ...
    public ResponseEntity<Map<String, Object>> getHelp() {
        ...
        quickCommands.put("POST /api/camp/full", "Run full sync");
        quickCommands.put("POST /api/camp/upload-only", "Upload only");
        quickCommands.put("GET /api/camp/status", "Check status");
        quickCommands.put("GET /api/camp/config", "View config");
        quickCommands.put("GET /api/camp/diagnostics", "Run diagnostics");
        quickCommands.put("GET /api/camp/docs", "Full documentation");
