...
public interface HeaderCreator {
    ...
    String[] getAllHeaders(FormMapping formMapping, Object mode) throws InvalidConfigurationException;
    String[] getAllMandatoryHeaders(FormMapping formMapping, Object mode) throws InvalidConfigurationException;
    String[] getConceptHeaders(FormMapping formMapping, String[] fileHeaders);
    String[] getAllDescriptions(FormMapping formMapping, Object mode) throws InvalidConfigurationException;
}
