...
import org.avni.server.dao.AvniJpaRepository;
...
public interface MenuItemRepository extends FindByLastModifiedDateTime<MenuItem>, CHSRepository<MenuItem>, AvniJpaRepository<MenuItem, Long> {
}
