...
@PreAuthorize(value = "hasAnyAuthority('user','admin') or hasAnyAuthority(T(org.avni.server.framework.security.UserContextHolder).getUserContext().getOrganisationId()+'<#@#>User<#@#>Edit user configuration')")
